	...
	\begin{table}[h!]
		\begin{tabularx}{\textwidth}{p{150pt}p{1pt}X}
			...
			\begin{minipage}[t]{\linewidth}
				...
				\begin{sectionitem}
					Dec 2017&\textbf{\href{http://www.bbc.co.uk/programmes/p05rmjz1}{Television Interview}}, \emph{BBC and \href{http://standalone.org.uk/}{Stand Alone}}\\
					\emph{London}&\begin{bullets}
						\smitem{Talked about the impact of estrangement over the Christmas period}
					\end{bullets}\\
				\end{sectionitem}
				...
				\begin{sectionitem}
					...
					&\begin{bullets}
						\smitem{Wrote a piece for the campaign's \href{http://www.thestandalonepledge.org.uk/images/thestandalonepledge/filer/ESSC_Information_Booklet_Sept_17.pdf}{information booklet} for SUs nationally}
						\smitem{Gave a presentation to SU Officers about my experiences as an estranged student and how to support estranged students at NUS Conference}
					\end{bullets}
				\end{sectionitem}
			\end{minipage}
		\end{tabularx}
			...
			\begin{minipage}[t]{\linewidth}
				...
				\begin{sectionitem}
					...
					\emph{Durham}&\begin{bullets}
						...
						\smitem{Assisted in delivering BA Education Studies presentations}
					\end{bullets}\\
				\end{sectionitem}
			...
			\begin{minipage}[t]{\linewidth}
				...
				\begin{sectionitem}
					...
					\emph{Nationwide}&\begin{bullets}
						...
						\smitem{Trained newly hired demonstrators}
					\end{bullets}\\
				\end{sectionitem}
